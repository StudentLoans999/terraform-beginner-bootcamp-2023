...
class Home
  ...
  # https:/guides.rubyonrails.org/active_model_basics.html
    # https:/guides.rubyonrails.org/active_model_validations.html
  ...
  # Ww will make sure it is an incremental version in the controller. 
...
class TerraTownsMockServer < Sinatra::Base
  ...
  post '/api/u/:user_uuid/homes' do
    ...
    # a begin/rescue is a try/ctach, if an error occurs. rescue it
    begin
    ...
    # Enusre our validation checks pass, otherwise
    # return the erros
    unless home.valid?
